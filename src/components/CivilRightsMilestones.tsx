...
const milestones: Milestone[] = [
  ...
  {
    title: "The Supreme Court Orders Ole Miss to Integrate (1962)",
    description:
  ...
  {
    title: "The Attica Prison Riot (1971)",
    description:
...
export default CivilRightsMilestones;
